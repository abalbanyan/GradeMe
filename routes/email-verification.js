...
router.post('/resend', function(req, res, next) {
    ...
    db.EmailVerification.resendVerificationEmail(email, function(err, userFound) {
        ...
        if (userFound) {
            ...
            res.render('email-verification', {errormessage: 'Your verification code has expired or you\'ve already confirmed your account. \nPlease sign up again or try logging in.'});                        
        }
    });
});
